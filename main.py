...
def explain_prediction(probability, input_dict, surname):
  ...
  Don't mention the probability of churning, or the machine learning model, and don't say anything like "Based on the machine learning model's prediction and top 10 most important features", just explain the prediction.

  Be smart and talk like a data scientist and a professional, don't use pronoun I.
